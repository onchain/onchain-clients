...
module OnchainApi
  class TransactionApi
    ...
    # @param body [PaymentRequest] 
    # @param [Hash] opts the optional parameters
    # @return [TransactionReply]
    def create_payment(coin_type, body, opts = {})
      data, _status_code, _headers = create_payment_with_http_info(coin_type, body, opts)
      data
    end
    ...
    def create_payment_with_http_info(coin_type, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TransactionApi.create_payment ...'
      end
      # verify the required parameter 'coin_type' is set
      if @api_client.config.client_side_validation && coin_type.nil?
        fail ArgumentError, "Missing the required parameter 'coin_type' when calling TransactionApi.create_payment"
      end
      # verify enum value
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling TransactionApi.create_payment"
      end
      # resource path
      local_var_path = '/api/payment/create/{coin_type}'.sub('{' + 'coin_type' + '}', CGI.escape(coin_type.to_s))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TransactionApi#create_payment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def create_transaction_with_http_info(coin_type, body, opts = {})
      ...
      # resource path
      local_var_path = '/api/transaction/create/{coin_type}'.sub('{' + 'coin_type' + '}', CGI.escape(coin_type.to_s))
    ...
    # @param coin_type [String] 
    # @param body [RawTransactionSendRequest] 
    # @param [Hash] opts the optional parameters
    ...
    def send_raw_with_http_info(coin_type, body, opts = {})
      ...
      # resource path
      local_var_path = '/api/transaction/send_raw/{coin_type}'.sub('{' + 'coin_type' + '}', CGI.escape(coin_type.to_s))
    ...
    def sign_and_send_with_http_info(coin_type, body, opts = {})
      ...
      # resource path
      local_var_path = '/api/transaction/sign_and_send/{coin_type}'.sub('{' + 'coin_type' + '}', CGI.escape(coin_type.to_s))
