...
# Unit tests for Onchain::OnchainTransactionSendRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OnchainTransactionSendRequest' do
  before do
    # run before each test
    @instance = Onchain::OnchainTransactionSendRequest.new
  end
  ...
  describe 'test an instance of OnchainTransactionSendRequest' do
    it 'should create an instance of OnchainTransactionSendRequest' do
      expect(@instance).to be_instance_of(Onchain::OnchainTransactionSendRequest)
    end
  end
