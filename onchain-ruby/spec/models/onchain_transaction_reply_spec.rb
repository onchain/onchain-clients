...
# Unit tests for SwaggerClient::OnchainTransactionReply
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OnchainTransactionReply' do
  before do
    # run before each test
    @instance = SwaggerClient::OnchainTransactionReply.new
  end
  ...
  describe 'test an instance of OnchainTransactionReply' do
    it 'should create an instance of OnchainTransactionReply' do
      expect(@instance).to be_instance_of(SwaggerClient::OnchainTransactionReply)
    end
  end
