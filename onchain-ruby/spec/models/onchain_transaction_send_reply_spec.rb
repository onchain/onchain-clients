...
# Unit tests for SwaggerClient::OnchainTransactionSendReply
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OnchainTransactionSendReply' do
  before do
    # run before each test
    @instance = SwaggerClient::OnchainTransactionSendReply.new
  end
  ...
  describe 'test an instance of OnchainTransactionSendReply' do
    it 'should create an instance of OnchainTransactionSendReply' do
      expect(@instance).to be_instance_of(SwaggerClient::OnchainTransactionSendReply)
    end
  end
