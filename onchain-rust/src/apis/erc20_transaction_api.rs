...
pub enum SignAndSendError {
    ...
    pub async fn create_transaction(configuration: &configuration::Configuration, body: crate::models::Erc20TransactionRequest) -> Result<crate::models::EthereumTransactionReply, Error<CreateTransactionError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/api/erc20/create", configuration.base_path);
    ...
    pub async fn sign_and_send(configuration: &configuration::Configuration, body: crate::models::EthereumTransactionSendRequest) -> Result<crate::models::TransactionSendReply, Error<SignAndSendError>> {
        ...
        let uri_str = format!("{}/api/erc20/sign_and_send", configuration.base_path);
        let mut req_builder = client.post(uri_str.as_str());
